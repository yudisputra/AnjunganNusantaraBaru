...
<html lang="en">
    <head>
        ...
        <title>Anjungan Nusantara - Daftar Sekarang</title>
        ...
        <!-- Google fonts -->
        <link rel='stylesheet' type='text/css' href='<?php echo base_url()?>https://fonts.googleapis.com/css?family=Lato:300,400,700'>
    </head>
    ...
    <body>
        ...
        <div class="login-wrapper columns is-gapless">
            ...
            <div class="column login-column is-8 is-hidden-mobile hero-banner">
                <div class="hero login-hero is-fullheight has-background-image" data-background="https://place-hold.it/1600x1064">
                ...
                <div class="hero is-fullheight">
                    <div class="hero-heading">
                        <div class="section has-text-centered">
                            <a href="startup.html"><img class="top-logo" src="<?php base_url() ?>assets/assetsbulma/images/logos/bulkit-logo.png" alt="Anjungan Nusantara"></a>
                        </div>
                        <div class="no-account-link has-text-centered">
                            <a href="<?php base_url() ?>Daftar"><i class="sl sl-icon-question pr-10"></i> I do not have an account yet </a>
                        </div>
                    </div>
                    <div class="hero-body">
                        <div class="container">
                                        ...
                                        <div id="signin-form" class="login-form animated preFadeInLeft fadeInLeft">
                                            ...
                                            <div class="field pb-10">
                                                <div class="control has-icons-right">
                                                    <input class="input required is-primary-focus is-large" type="email" placeholder="Email" required>
                                            ...
                                            <div class="field pb-10">
                                                <div class="control has-icons-right">
                                                    <input class="input required is-primary-focus is-large" type="password" placeholder="Password" required>
                                                    <span class="icon is-medium is-right">
